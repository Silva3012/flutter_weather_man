...
abstract class $WeatherResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({double temperature, double weatherCode});
}
...
class _$WeatherResponseImpl implements _WeatherResponse {
  ...
  @override
  String toString() {
    return 'WeatherResponse(temperature: $temperature, weatherCode: $weatherCode)';
  }
...
abstract class _WeatherResponse implements WeatherResponse {
  const factory _WeatherResponse(
      ...
      required final double weatherCode}) = _$WeatherResponseImpl;
